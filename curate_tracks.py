...
BEATPORT_GENRE_SLUGS = {
    # — слаги Beatport V4. Алиасы (несколько фраз → один слаг). Проверить вживую у Гермеса. —
    ...
    "peak time techno": "techno-peak-time-driving",
    ...
    "electro house": "electro-classic-detroit-modern",
    ...
    "club": "bass-club",
    "mainstage": "mainstage",
    "hardcore": "hard-dance-hardcore-neo-rave",
    "hard dance": "hard-dance-hardcore-neo-rave",
    "dance": "dance-pop",
    "pop": "dance-pop",
}
