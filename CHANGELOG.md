...
### [mixer] — Bass swap fix: двойное ослабление + бас-дыра в конце перехода
  • **Баг:** eq_sweep HPF 20→150 Гц на мастере + LPF 150→20 Гц на слейве + fast_fo/fast_fi амплитудный кроссфейд — двойное ослабление низа. LPF 150→20 Гц на слейве вырезал бас входящего трека к концу перехода → бас-дыра ~96% с резким восстановлением.
  • **Фикс:** убран eq_sweep на низкой полосе. Оставлен один constant-sum кроссфейд (cos²/sin²) на сырых LR4-низах. Бас полностью передаётся слейву за первые 25% перехода.
  • Поведение теперь совпадает с README («instant bass swap with smoothing»).
